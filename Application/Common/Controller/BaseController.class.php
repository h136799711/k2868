...
class BaseController extends Controller{
	 ...
	 * Seo 配置
	 * */
	public function assignVars($seo=array('title'=>'标题','keywords'=>'关键词','description'=>'描述',),							$varsConfig=array('owner'=>'绍兴古睿信息科技有限公司')){
		$this->seo = array_merge($this->seo,$seo);
		$this->varsConfig = array_merge($this->varsConfig,$varsConfig);
		
		$this->assign("seo",$this->seo);
		$this->assign("varsConfig",$this->varsConfig);
	}
	/**
	 * 赋值页面标题值
	 */

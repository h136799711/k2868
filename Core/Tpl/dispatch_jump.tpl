...
<html>
	...
	<head>
		...
		<style type="text/css">
			*{ padding: 0; margin: 0; }
			        ...
			        .system-message{ padding: 0 0 20px;margin: 10px auto;max-width: 400px;background-color:#f8f8f8;border-radius: 6px;}
	...
	<body>
		<div class="system-message">
			<p class="title">系统提醒</p>
			<div>
				<present name="message">
					<div class="success"><span><?php echo($message); ?></span>
					</div>
					<else/>
					<div class="error"><span style="padding-top:0px;"><?php echo($error); ?></span>
					</div>
				</present>
